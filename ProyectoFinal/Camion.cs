    ...
    internal class Camion : Vehiculo
    {
        ...
        public override void Editar()
        {
            ...
            while (cond)
            {
                ...
                Console.WriteLine("13- Dimension de la caja");
                Console.WriteLine("14- Carga maxima");
                Console.WriteLine();
                ...
                switch (opcion)
                {
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        Console.Write("Ingrese nueva dimension de la caja:");
                        this.dimensionCaja = int.Parse(Console.ReadLine());
                        break;
                    case 14:
                        Console.Write("Ingrese nueva carga maxima:");
                        this.cargaMax = int.Parse(Console.ReadLine());
                        break;
                    case 0:
                        cond = false;
                        break;
